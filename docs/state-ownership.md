...
- `costDisplayMode` (`i_cost_display`) — reciprocal cost presentation: `tokens-per-dollar` (default) or `cost-per-million`
...
| `i_cost_display` | InferenceProvider   | `tokens-per-dollar`               |
