...
- [Architecture](./architecture.md) — Why client-first, filesystem tab routing, URL state, provider nesting, server-side caching (unstable_cache + blob), in-memory client cache, color system, analytics enforcement
