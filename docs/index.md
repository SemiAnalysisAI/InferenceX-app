...
- [Immutable Measurement Publication](./measurement-publication.md) / [中文](./measurement-publication_zh.md) — Receipt authority, exact artifact transport, immutable replay and run-scoped acceptance
