...
- [PowerX in Measured Power / Energy](./powerx-permanent-view.md) / [中文](./powerx-permanent-view_zh.md) — Article graph coverage, four power boundaries, role energy, serving-window traces and reproducible shares
