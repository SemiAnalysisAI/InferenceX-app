...
export const METRIC_KEYS = new Set([
  ...
  // AgentX retrospective cumulative-prefix convergence. A metric stabilizes
  // only when every later checkpoint remains within the configured symmetric
  // ratio band and the minimum confirmation horizon is available.
  ...
  'convergence_p75_ttft_min',
  'convergence_p75_ttft_max',
  'convergence_p75_ttft_max_relative_deviation',
  'convergence_p90_ttft_time_seconds',
  'convergence_p90_ttft_requests',
  'convergence_p90_ttft_min',
  'convergence_p90_ttft_max',
  'convergence_p90_ttft_max_relative_deviation',
  'convergence_p75_e2el_time_seconds',
  'convergence_p75_e2el_requests',
  'convergence_p75_e2el_min',
  'convergence_p75_e2el_max',
  'convergence_p75_e2el_max_relative_deviation',
  'convergence_p90_e2el_time_seconds',
  'convergence_p90_e2el_requests',
  'convergence_p90_e2el_min',
  'convergence_p90_e2el_max',
  'convergence_p90_e2el_max_relative_deviation',
  'convergence_p75_intvty_time_seconds',
  'convergence_p75_intvty_requests',
  'convergence_p75_intvty_min',
  'convergence_p75_intvty_max',
  'convergence_p75_intvty_max_relative_deviation',
  'convergence_p90_intvty_time_seconds',
  'convergence_p90_intvty_requests',
  'convergence_p90_intvty_min',
  'convergence_p90_intvty_max',
  'convergence_p90_intvty_max_relative_deviation',
]);
