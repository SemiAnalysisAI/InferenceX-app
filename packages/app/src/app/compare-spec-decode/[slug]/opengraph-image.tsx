/**
 * Spec-decode compare OG image — identical circuit tile sidebar layout to the
 * /compare OG and the blog OG, but the eyebrow and bottom banner are swapped
 * to surface the "Speculative Decoding" framing.
 */
...
export const alt = 'GPU speculative decoding inference benchmark comparison';
      ...
      >
        ...
        >
          <span style={{ fontSize: 26, color: '#9BA0A6', display: 'flex' }}>
            AI inference benchmark · speculative decoding comparison
          </span>
