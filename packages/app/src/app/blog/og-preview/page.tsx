const VARIANTS = [
  ...
  { id: 'v126', name: 'V126: Ancient Scroll — Parchment with rolled scroll edges' },
  { id: 'v127', name: 'V127: Cave Painting — Ochre hand-prints, primitive marks' },
  { id: 'v128', name: 'V128: Art Deco — Gold sunburst rays, Gatsby-era elegance' },
  { id: 'v129', name: 'V129: Constructivist — Soviet propaganda, red/black diagonal' },
  { id: 'v130', name: 'V130: Ukiyo-e — Japanese woodblock, wave patterns, cartouche' },
  { id: 'v131', name: 'V131: Stained Glass — Jewel-toned panes with lead borders' },
  { id: 'v132', name: 'V132: Hieroglyphs — Egyptian cartouche, gold glyph bands' },
  { id: 'v133', name: 'V133: Illuminated — Medieval manuscript, ornate initial letter' },
  { id: 'v134', name: 'V134: Pop Art — Warhol 2x2 quadrants, bold colors' },
  { id: 'v135', name: 'V135: Bauhaus — White bg, primary color shapes, Dessau school' },
  { id: 'v136', name: 'V136: Chalkboard — Green board, chalk text, eraser' },
  { id: 'v137', name: 'V137: Neon Sign — Glowing tubes on black, double-line effect' },
  { id: 'v138', name: 'V138: Leather Book — Embossed dark brown, gold double frame' },
  { id: 'v139', name: 'V139: Shipping Label — Kraft brown, FRAGILE stamp, barcode' },
  { id: 'v140', name: 'V140: Polaroid — White-bordered photo with handwritten caption' },
  { id: 'v141', name: 'V141: Cassette — Tape reels, SIDE A, retro label' },
  { id: 'v142', name: 'V142: License Plate — Embossed text, state label, stickers' },
  { id: 'v143', name: 'V143: Credit Card — Chip, card number, holographic stripe' },
  { id: 'v144', name: 'V144: Prescription — Rx label, dosage instructions' },
  { id: 'v145', name: 'V145: Billboard — Highway sign, green bg, EXIT number' },
  { id: 'v146', name: 'V146: DNA Helix — Double strand dots with connecting rungs' },
  { id: 'v147', name: 'V147: Star Chart — Stars, constellations, coordinate grid' },
  { id: 'v148', name: 'V148: Weather Map — Radar rings, blips, station readout' },
  { id: 'v149', name: 'V149: Periodic Element — Table cell with atomic number/symbol' },
  { id: 'v150', name: 'V150: Microscope — Slide with circular lens view, scale bar' },
  { id: 'v151', name: 'V151: Seismograph — Waveform on graph paper, red alerts' },
  { id: 'v152', name: 'V152: Aurora — Northern lights curtain, stars, treeline' },
  { id: 'v153', name: 'V153: Coral Reef — Underwater with coral shapes, bubbles' },
  { id: 'v154', name: 'V154: Crystal — Amethyst/ice crystal shards from corner' },
  { id: 'v155', name: 'V155: Telescope — Eyepiece circle with crosshairs, stars' },
  { id: 'v156', name: 'V156: Receipt — Thermal paper, dashed lines, TOTAL: 1 ARTICLE' },
  { id: 'v157', name: 'V157: Passport — Document page with MRZ zone, photo placeholder' },
  { id: 'v158', name: 'V158: Ransom Note — Cut-out words, mixed sizes/colors, chaotic' },
  { id: 'v159', name: 'V159: Typewriter — Off-white paper, typed text, carriage' },
  { id: 'v160', name: 'V160: Sticky Note — Yellow Post-it on dark bg, pin at top' },
  { id: 'v161', name: 'V161: Safety Card — Airline style, numbered steps, pictograms' },
  { id: 'v162', name: 'V162: Nutrition Label — FDA format, Blog Facts, serving size' },
  { id: 'v163', name: 'V163: Warning Sign — Yellow triangle, hazard stripes' },
  { id: 'v164', name: 'V164: Test Pattern — TV color bars, PLEASE STAND BY' },
  { id: 'v165', name: 'V165: Boot Screen — BIOS text, green on black, system boot' },
  { id: 'v166', name: 'V166: Mondrian — Primary color grid, De Stijl composition' },
  { id: 'v167', name: 'V167: Rothko — Stacked color field blocks, contemplative' },
  { id: 'v168', name: 'V168: Kandinsky — Scattered geometric shapes, abstract energy' },
  { id: 'v169', name: 'V169: Impossible — Escher impossible triangle illusion' },
  { id: 'v170', name: 'V170: Op Art — Concentric circles, moiré vibrating effect' },
  { id: 'v171', name: 'V171: Data Mosh — RGB channel offset, glitch corruption' },
  { id: 'v172', name: 'V172: Risograph — Two-color overprint, offset registration' },
  { id: 'v173', name: 'V173: Linocut — Bold white on dark, woodcut leaf patterns' },
  { id: 'v174', name: 'V174: Psychedelic — Nested rounded rects, groovy 60s colors' },
  { id: 'v175', name: 'V175: Hologram — Cyan scan lines, magenta offset, Blade Runner' },
];
