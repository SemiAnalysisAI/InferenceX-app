 ...
 * (the default), GLM 5.2/5.3, and MiniMax M3. The per-GW view also offers
 * Qwen3.5 fixed 8k/1k power planning. Other slugs 404 there and stay out of
 * the sitemap. Tabs absent from this map offer every model.
 */
