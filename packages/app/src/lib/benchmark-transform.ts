...
export function rowToAggDataEntry(row: BenchmarkRow): AggDataEntry {
  ...
  return {
    ...
    observed_window_seconds: m.observed_window_seconds,
    observed_window_expected_count: m.observed_window_expected_count,
    observed_window_count: m.observed_window_count,
    observed_window_min_requests: m.observed_window_min_requests,
    root_trajectory_count: m.root_trajectory_count,
    root_trajectory_kish_effective_count: m.root_trajectory_kish_effective_count,
    root_trajectory_largest_share: m.root_trajectory_largest_share,
    observed_window_p75_ttft_min: m.observed_window_p75_ttft_min,
    observed_window_p75_ttft_max: m.observed_window_p75_ttft_max,
    observed_window_p90_ttft_min: m.observed_window_p90_ttft_min,
    observed_window_p90_ttft_max: m.observed_window_p90_ttft_max,
    observed_window_p75_e2el_min: m.observed_window_p75_e2el_min,
    observed_window_p75_e2el_max: m.observed_window_p75_e2el_max,
    observed_window_p90_e2el_min: m.observed_window_p90_e2el_min,
    observed_window_p90_e2el_max: m.observed_window_p90_e2el_max,
    observed_window_p75_intvty_min: m.observed_window_p75_intvty_min,
    observed_window_p75_intvty_max: m.observed_window_p75_intvty_max,
    observed_window_p90_intvty_min: m.observed_window_p90_intvty_min,
    observed_window_p90_intvty_max: m.observed_window_p90_intvty_max,
    convergence_checkpoint_seconds: m.convergence_checkpoint_seconds,
    convergence_tolerance_ratio: m.convergence_tolerance_ratio,
    convergence_min_confirmation_seconds: m.convergence_min_confirmation_seconds,
    convergence_horizon_seconds: m.convergence_horizon_seconds,
    convergence_p75_ttft_time_seconds: m.convergence_p75_ttft_time_seconds,
    convergence_p75_ttft_requests: m.convergence_p75_ttft_requests,
    convergence_p75_ttft_min: m.convergence_p75_ttft_min,
    convergence_p75_ttft_max: m.convergence_p75_ttft_max,
    convergence_p75_ttft_max_relative_deviation: m.convergence_p75_ttft_max_relative_deviation,
    convergence_p90_ttft_time_seconds: m.convergence_p90_ttft_time_seconds,
    convergence_p90_ttft_requests: m.convergence_p90_ttft_requests,
    convergence_p90_ttft_min: m.convergence_p90_ttft_min,
    convergence_p90_ttft_max: m.convergence_p90_ttft_max,
    convergence_p90_ttft_max_relative_deviation: m.convergence_p90_ttft_max_relative_deviation,
    convergence_p75_e2el_time_seconds: m.convergence_p75_e2el_time_seconds,
    convergence_p75_e2el_requests: m.convergence_p75_e2el_requests,
    convergence_p75_e2el_min: m.convergence_p75_e2el_min,
    convergence_p75_e2el_max: m.convergence_p75_e2el_max,
    convergence_p75_e2el_max_relative_deviation: m.convergence_p75_e2el_max_relative_deviation,
    convergence_p90_e2el_time_seconds: m.convergence_p90_e2el_time_seconds,
    convergence_p90_e2el_requests: m.convergence_p90_e2el_requests,
    convergence_p90_e2el_min: m.convergence_p90_e2el_min,
    convergence_p90_e2el_max: m.convergence_p90_e2el_max,
    convergence_p90_e2el_max_relative_deviation: m.convergence_p90_e2el_max_relative_deviation,
    convergence_p75_intvty_time_seconds: m.convergence_p75_intvty_time_seconds,
    convergence_p75_intvty_requests: m.convergence_p75_intvty_requests,
    convergence_p75_intvty_min: m.convergence_p75_intvty_min,
    convergence_p75_intvty_max: m.convergence_p75_intvty_max,
    convergence_p75_intvty_max_relative_deviation: m.convergence_p75_intvty_max_relative_deviation,
    convergence_p90_intvty_time_seconds: m.convergence_p90_intvty_time_seconds,
    convergence_p90_intvty_requests: m.convergence_p90_intvty_requests,
    convergence_p90_intvty_min: m.convergence_p90_intvty_min,
    convergence_p90_intvty_max: m.convergence_p90_intvty_max,
    convergence_p90_intvty_max_relative_deviation: m.convergence_p90_intvty_max_relative_deviation,
  };
}
