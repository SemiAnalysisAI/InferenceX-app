...
export const METRIC_REGISTRY = {
  ...
  tokenRevenuePerGwYear: {
    field: 'tokenRevenuePerGwYear.y',
    label: 'Token Revenue per All in Utility GW per Year ($/GW/yr)',
    labelZh: '每全电源配置吉瓦每年 token 收入（$/GW/yr）',
    title: 'Token Revenue per All in Utility GW per Year',
    titleZh: '每全电源配置吉瓦每年 token 收入',
    polarity: 'higher',
  },
  tokenProfitPerGwYearH: {
    field: 'tokenProfitPerGwYearH.y',
    label: 'Token Profit per All in Utility GW per Year ($/GW/yr)',
    labelZh: '每全电源配置吉瓦每年 token 利润（$/GW/yr）',
    title: 'Token Profit per All in Utility GW per Year (Owning - Hyperscaler)',
    titleZh: '每全电源配置吉瓦每年 token 利润（自有 - 超大规模）',
    polarity: 'higher',
  },
  tokenProfitPerGwYearN: {
    field: 'tokenProfitPerGwYearN.y',
    label: 'Token Profit per All in Utility GW per Year ($/GW/yr)',
    labelZh: '每全电源配置吉瓦每年 token 利润（$/GW/yr）',
    title: 'Token Profit per All in Utility GW per Year (Owning - Neocloud Giant)',
    titleZh: '每全电源配置吉瓦每年 token 利润（自有 - Neocloud Giant）',
    polarity: 'higher',
  },
  tokenProfitPerGwYearR: {
    field: 'tokenProfitPerGwYearR.y',
    label: 'Token Profit per All in Utility GW per Year ($/GW/yr)',
    labelZh: '每全电源配置吉瓦每年 token 利润（$/GW/yr）',
    title: 'Token Profit per All in Utility GW per Year (3 Year Rental)',
    titleZh: '每全电源配置吉瓦每年 token 利润（3 年租赁）',
    polarity: 'higher',
  },
  tokensPerDollarH: {
...
export const METRIC_CONTROL_GROUPS: readonly MetricControlGroup[] = [
  ...
  },
  {
    label: 'Token Revenue',
    labelZh: 'token 收入',
    metrics: ['y_tokenRevenuePerGpuHour', 'y_tokenRevenuePerGwYear'],
  },
  {
    label: 'Token Profit per All in Utility GW per Year',
    labelZh: '每全电源配置吉瓦每年 token 利润',
    metrics: ['y_tokenProfitPerGwYearH', 'y_tokenProfitPerGwYearN', 'y_tokenProfitPerGwYearR'],
  },
  {
