...
export const METRIC_REGISTRY = {
  ...
  tokenRevenuePerMwYear: {
    field: 'tokenRevenuePerMwYear.y',
    label: 'Token Revenue per All in Utility MW per Year ($/MW/yr)',
    labelZh: '每全电源配置兆瓦每年 token 收入（$/MW/yr）',
    title: 'Token Revenue per All in Utility MW per Year',
    titleZh: '每全电源配置兆瓦每年 token 收入',
    polarity: 'higher',
  },
  tokenProfitPerMwYearH: {
    field: 'tokenProfitPerMwYearH.y',
    label: 'Token Profit per All in Utility MW per Year ($/MW/yr)',
    labelZh: '每全电源配置兆瓦每年 token 利润（$/MW/yr）',
    title: 'Token Profit per All in Utility MW per Year (Owning - Hyperscaler)',
    titleZh: '每全电源配置兆瓦每年 token 利润（自有 - 超大规模）',
    polarity: 'higher',
  },
  tokenProfitPerMwYearN: {
    field: 'tokenProfitPerMwYearN.y',
    label: 'Token Profit per All in Utility MW per Year ($/MW/yr)',
    labelZh: '每全电源配置兆瓦每年 token 利润（$/MW/yr）',
    title: 'Token Profit per All in Utility MW per Year (Owning - Neocloud Giant)',
    titleZh: '每全电源配置兆瓦每年 token 利润（自有 - Neocloud Giant）',
    polarity: 'higher',
  },
  tokenProfitPerMwYearR: {
    field: 'tokenProfitPerMwYearR.y',
    label: 'Token Profit per All in Utility MW per Year ($/MW/yr)',
    labelZh: '每全电源配置兆瓦每年 token 利润（$/MW/yr）',
    title: 'Token Profit per All in Utility MW per Year (3 Year Rental)',
    titleZh: '每全电源配置兆瓦每年 token 利润（3 年租赁）',
    polarity: 'higher',
  },
  tokensPerDollarH: {
...
export const METRIC_CONTROL_GROUPS: readonly MetricControlGroup[] = [
  ...
  },
  {
    label: 'Token Revenue',
    labelZh: 'token 收入',
    metrics: ['y_tokenRevenuePerGpuHour', 'y_tokenRevenuePerMwYear'],
  },
  {
    label: 'Token Profit per All in Utility MW per Year',
    labelZh: '每全电源配置兆瓦每年 token 利润',
    metrics: ['y_tokenProfitPerMwYearH', 'y_tokenProfitPerMwYearN', 'y_tokenProfitPerMwYearR'],
  },
  {
