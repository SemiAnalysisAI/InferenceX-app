...
export const METRIC_REGISTRY = {
  ...
  outputTputPerGpu: {
    ...
    labelZh: '每 Chip 输出 token 吞吐量（tok/s/chip）',
    title: 'Output Token Throughput per Chip',
    titleZh: '每 Chip 输出 token 吞吐量',
    polarity: 'higher',
  },
  tpPerMw: {
    field: 'tpPerMw.y',
  ...
  tokensPerDollarH: {
    ...
    label: 'Total Tokens per $1 (tok/$)',
    labelZh: '每 1 美元可购买的总 token 数（tok/$）',
    title: 'Total Tokens per $1 (Owning - Hyperscaler)',
  ...
  tokensPerDollarN: {
    ...
    label: 'Total Tokens per $1 (tok/$)',
    labelZh: '每 1 美元可购买的总 token 数（tok/$）',
    title: 'Total Tokens per $1 (Owning - Neocloud Giant)',
  ...
  outputTokensPerDollarN: {
    ...
    label: 'Output Tokens per $1 (tok/$)',
    labelZh: '每 1 美元可购买的输出 token 数（tok/$）',
    title: 'Output Tokens per $1 (Owning - Neocloud Giant)',
  ...
  inputTokensPerDollarN: {
    ...
    label: 'Input Tokens per $1 (tok/$)',
    labelZh: '每 1 美元可购买的输入 token 数（tok/$）',
    title: 'Input Tokens per $1 (Owning - Neocloud Giant)',
  ...
  inputTokensPerDollarR: {
    ...
    label: 'Input Tokens per $1 (tok/$)',
    labelZh: '每 1 美元可购买的输入 token 数（tok/$）',
    title: 'Input Tokens per $1 (3 Year Rental)',
  ...
  tokensPerDollarUser: {
    ...
    label: 'Total Tokens per $1 (tok/$)',
    labelZh: '每 1 美元可购买的总 token 数（tok/$）',
    title: 'Total Tokens per $1 (Custom User Values)',
