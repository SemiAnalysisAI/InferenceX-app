 ...
 * in the description (Google, OpenAI, AMD, NVIDIA), then SambaNova, followed
 * by Meta, Microsoft, and Oracle. The path data is copied from the shared brand assets under
 ...
 * SambaNova is its purple ribbon mark (the current sambanova.ai header and
 * favicon; the shared `sambanova.webp` asset is raster only), traced into
 * three stacked flat fills sampled from the official gradient: deep plum
 * #2A1246, violet #7340B8, and lilac #CC8FF3 highlights. Used as-is in both themes.
...
const VENDOR_MARKS: readonly {
  ...
  },
  {
    ...
    paths: [
      {
        d: 'M10.3 21.65C8.39 21.34 6.19 19.75 4.17 17.23C2.24 14.82 0.43 11.51 0.11 9.84C-0.1 8.71 0.02 7.98 0.52 7.42C0.74 7.16 1.41 6.71 1.89 6.48C2.34 6.28 3.48 5.89 3.96 5.79C4.46 5.68 5.58 5.52 6.61 5.41L7.42 5.32L8.17 4.75C11.23 2.42 14.06 0.87 16.36 0.27C18.23 -0.22 19.54 -0.05 20.6 0.82C22.41 2.3 23.68 5.38 23.96 8.96C24.02 9.75 23.99 11.57 23.9 12.23C23.64 14.09 23.17 15.45 22.41 16.57C21.32 18.16 17.16 20.48 13.87 21.34C12.97 21.57 12.24 21.68 11.42 21.69C10.9 21.7 10.56 21.69 10.3 21.65ZM18.52 15.4C19.33 14.5 20.2 13.4 20.77 12.56C21.66 11.27 21.97 9.78 21.56 8.85C21.23 8.12 19.91 7.4 18.17 7.01C15.81 6.49 12.19 6.41 8.82 6.82C7.93 6.93 7.8 6.99 7.13 7.59C5.17 9.36 4 10.55 3.62 11.17L3.52 11.33L3.79 11.59C4.56 12.31 5.58 12.85 7.53 13.56C10.63 14.69 15.33 15.76 17.93 15.92C18.03 15.93 18.12 15.84 18.52 15.4Z',
        fill: '#2A1246',
      },
      {
        d: 'M15.02 20.15C16.88 18.97 18.75 17.13 20.27 15.01C21.38 13.45 22.29 11.77 22.68 10.54C22.9 9.86 22.97 9.48 22.97 8.94C22.98 8.53 22.96 8.42 22.87 8.17C22.68 7.62 22.39 7.28 21.84 6.92C20.76 6.22 18.54 5.73 15.75 5.57C14.78 5.51 10.57 5.54 9.46 5.61C5.64 5.86 3.19 6.23 1.6 6.8C1.33 6.9 1.1 6.98 1.09 6.97C1.06 6.94 1.62 6.61 1.92 6.47C2.42 6.24 3.55 5.87 4.1 5.76C4.67 5.65 5.75 5.5 6.99 5.36L7.84 5.27L8.21 5.05C9.42 4.35 10.99 3.54 12.34 2.93C14.15 2.11 15.93 1.51 17.34 1.24C17.74 1.16 17.97 1.14 18.7 1.15C19.51 1.15 19.6 1.15 20.01 1.26C20.99 1.5 21.51 1.88 22.04 2.73C23.03 4.32 23.73 6.76 23.88 9.1C23.99 10.71 23.75 12.61 23.27 14.06C22.95 15 22.37 16.08 21.9 16.62L21.75 16.78L21.9 16.48C22.33 15.61 22.92 14.26 22.92 14.15C22.92 14.14 22.79 14.38 22.64 14.69C22.31 15.34 21.88 16.01 21.27 16.81C20.84 17.37 20.67 17.57 20.91 17.21C21.34 16.59 21.87 15.
.29 15.52 4.26 17.18 4.26C18.6 4.26 18.86 4.28 19.45 4.36C20.58 4.51 21.51 4.76 21.98 5.03C22.1 5.1 22.2 5.15 22.21 5.15C22.22 5.15 22.12 5.05 21.98 4.92ZM13.5 3.87C15.18 3.54 16.39 3.37 17.72 3.28C19.25 3.18 20.78 3.37 21.62 3.75L21.9 3.87L21.77 3.74C21.47 3.42 20.74 3.11 19.96 2.97C19.38 2.86 17.96 2.87 17.09 2.99C15.91 3.15 14.82 3.39 13.29 3.81C12.1 4.14 12.11 4.15 13.5 3.87ZM12.67 3.48C15.58 2.52 17.48 2.16 19.24 2.22C19.96 2.24 20.43 2.31 20.87 2.45L21.11 2.54L20.96 2.41C20.46 1.97 19.36 1.74 18.23 1.83C16.57 1.96 14.88 2.43 12.6 3.38C11.94 3.66 11.54 3.84 11.65 3.81C11.68 3.8 12.14 3.65 12.67 3.48Z',
        fill: '#7340B8',
      },
      {
        d: 'M15.06 20.16C15.06 20.15 15.19 20.05 15.36 19.94C17.2 18.72 19.11 16.76 20.58 14.58C22.1 12.33 22.92 10.47 22.99 9.11C23.03 8.3 22.86 7.84 22.34 7.32C21.99 6.96 21.62 6.73 21.07 6.51C19.04 5.69 15.77 5.37 11.06 5.53C6.87 5.67 3.75 6.07 1.81 6.72C1.23 6.91 1.16 6.92 1.27 6.84C1.64 6.53 3.17 5.95 4.1 5.76C5.23 5.53 7.37 5.3 9.94 5.13C11.27 5.05 15.09 5.01 16.31 5.07C19.21 5.22 21.17 5.68 22.34 6.49C23.32 7.17 23.67 8.06 23.44 9.28C23.35 9.77 23.04 10.89 22.85 11.38C22.46 12.44 21.67 13.74 20.39 15.43C19.02 17.24 18.14 18.13 16.76 19.12C16.26 19.48 15.06 20.21 15.06 20.16ZM10.98 20C9.74 19.76 8.08 18.63 6.36 16.86C4.04 14.47 2.24 11.61 1.85 9.69C1.76 9.27 1.75 8.52 1.83 8.34C1.88 8.22 1.88 8.24 1.99 8.78C2.32 10.35 2.88 11.55 4.25 13.58C5.08 14.81 5.88 15.78 6.97 16.87C8.8 18.71 10.34 19.61 11.78 19.7C12.43 19.74 13.31 19.52 14.11 19.11C14.27 19.03 14.39 18.97 14.39 18.98C14.39 19.02 13.53 19.51 13.23 19.65C12.84 19.82 12.58 19.91 12.23 19.99C11.93 20.05 11.27 20.06 10.98 20Z',
        fill: '#CC8FF3',
      },
    ],
  },
...
const LANDING_HARDWARE_RESULTS = [
  ...
  },
  {
    ...
    subtitle: 'DeepSeek R1 · 8K/1K · FP4 · STP',
    href: '/inference/deepseek-r1?i_seq=8k%2F1k&i_prec=fp4&i_spec=stp&i_xmode=e2e',
    model: 'deepseek-r1',
...
const STRINGS = {
  en: {
    ...
    description:
      'Long Context Multi Turn Inference Performance. Compare Across Google TPUv7 Ironwood, OpenAI Jalapeño, MI355X, GB300 NVL72, GB200 NVL72, B200, H200, H100, RTX Pro, and soon TPUv8i, SambaNova SN50, Rubin NVL72, MI455X UALoE72',
