...
const SESSION_KEY = 'inferencex-eval-samples-nudge-shown';
...
/**
 * One-shot nudge that points new users at the per-sample drawer on the
 * evaluation tab. Mirrors the StarNudge pattern: sessionStorage gates
 * repeats, the drawer-opens event dismisses it (if the user finds the
