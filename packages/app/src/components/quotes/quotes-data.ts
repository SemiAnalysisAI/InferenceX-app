...
/** Order in which groups render on /quotes. */
...
export interface Quote {
  ...
  logo?: string;
  link?: string;
  /** True when the logo asset is a photograph (or any image whose colors are
   *  meaningful), so dark-mode rendering should skip the default `invert`. */
  logoIsPhoto?: boolean;
}
...
export const QUOTES: Quote[] = [
  ...
  {
    text: "Speed is the moat. InferenceX's nightly benchmarks match the speed of improvement of the AMD software stack. It's fantastic to see AMD's MI300, MI325, and MI355 GPUs performing so well across diverse workloads and interactivity levels.",
  ...
  {
    text: 'Oracle Cloud Infrastructure is built to give frontier labs & enterprises flexibility and choice, with many GPU SKUs available for AI at scale. InferenceX strengthens that mission by delivering open source, reproducible benchmarks that reflect real-world performance, efficiency, and cost on the latest hardware and software. With this transparency, customers can confidently select the platforms that best align with their AI strategies.',
    name: 'Jay Jackson',
    group: 'AI Industry Leaders',
  ...
  },
  {
    ...
    name: 'Tri Dao',
    group: 'AI Companies and Startups',
  ...
  {
    text: 'InferenceX has been useful for us even if Dylan Patel is a nice little guy with feelings',
  ...
  {
    text: "At Crusoe, we believe being a great partner means empowering our customers with choice and clarity. That's why we're proud to support InferenceX, which provides the entire AI community with open-source, reproducible benchmarks for the latest hardware. By delivering transparent, real-world data on throughput, efficiency, and cost, InferenceX cuts through the hype and helps our customers confidently select the very best platform for their unique workloads.",
  ...
  {
    text: "At TensorWave, we're building a next-generation cloud on AMD GPUs because we believe innovation thrives when customers have strong alternatives. InferenceX reinforces that vision by providing open source, reproducible benchmarks that track throughput, efficiency, and cost across the latest hardware and software. By cutting through synthetic numbers and highlighting real-world inference performance, it helps customers see the full potential of AMD platforms for AI at scale.",
    name: 'Darrick Horton',
    group: 'Infrastructure Providers',
  ...
  {
    text: "The industry needs many public, reproducible benchmarks of inference performance. We're excited to collaborate with InferenceX from the vLLM team. More diverse workloads and scenarios that everyone can trust and reference will help the ecosystem move forward. Fair, transparent measurements drive progress across every layer of the stack, from model architectures to inference engines to hardware.",
    name: 'Simon Mo',
    group: 'Inference Engines and Frameworks',
  ...
  {
    text: 'InferenceX benchmark is pogchamp & W in chat',
    name: 'Kaichao You',
    group: 'Inference Engines and Frameworks',
  ...
  },
  {
    ...
    name: 'Hao Zhang',
    group: 'Researchers and Academia',
  ...
  },
  {
    ...
    name: 'Stas Bekman',
    group: 'Researchers and Academia',
    title: 'Developer & Author of <em>Machine Learning Engineering Open Book</em> (17.5K+ \u2B50)',
    org: 'Stas Bekman',
  ...
  },
  {
    ...
    name: 'Mark Saroufim',
    group: 'Community and Content Creators',
