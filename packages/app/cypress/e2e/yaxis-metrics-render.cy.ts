...
describe('Y-Axis Metrics All Render Data', () => {
  const metrics = [
    ...
    'Total Tokens per $1 (Owning - Neocloud Giant)',
    'Total Tokens per $1 (3 Year Rental)',
    'Output Tokens per $1 (Owning - Hyperscaler)',
    'Output Tokens per $1 (Owning - Neocloud Giant)',
    'Output Tokens per $1 (3 Year Rental)',
    'Input Tokens per $1 (Owning - Hyperscaler)',
    'Input Tokens per $1 (Owning - Neocloud Giant)',
    'Input Tokens per $1 (3 Year Rental)',
    'Cost per Million Total Tokens (Custom User Values)',
    'Total Tokens per $1 (Custom User Values)',
