...
- `/blog/best-gpu-for-qwen35-inference` (Qwen-3.5-397B-A17B)
- `/blog/best-gpu-for-kimik25-inference` (Kimi-K2.5)
- `/blog/best-gpu-for-minimaxm25-inference` (MiniMax-M2.5)

Note: Slugs are auto-generated by stripping dots from modelKey. If these change,
