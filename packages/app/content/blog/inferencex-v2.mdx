...
<Figure
  ...
  caption="Source: InferenceMAX GitHub"
/>
...
<Figure
  ...
  caption="Source: Dwarkesh Podcast and SemiAnalysis"
/>
...
<Figure
  ...
  caption="Source: Nvidia GTC 2024"
/>
...
<Figure
  ...
  caption="Source: Brendan Bycroft"
/>
...
<Figure
  ...
  caption="An EP8 DP8 deployment of DeepSeek R1. All 256 experts per layer are divided evenly among the 8 GPUs, whereas attention along with other non-expert weights (shared expert, gating network, RMSNorm, LM head, etc.) are replicated across all 8 DP ranks. Source: SemiAnalysis"
/>
...
<Figure
  ...
  caption="A WideEP EP64 DP64 deployment of DeepSeek R1. All 256 experts per layer are divided evenly among the 64 GPUs (8 nodes), and attention and other non-expert weights (shared expert, gating network, RMSNorm, LM head, etc.) are replicated across all 64 DP ranks. Source: SemiAnalysis"
/>
...
<Figure
  ...
  caption="Source: SemiAnalysis InferenceMAX"
/>
...
<Figure
  ...
  caption="Source: Outages project"
/>
...
_This article continues with a detailed Total Cost of Ownership analysis across all GPU SKUs. The full article is available on our Substack. [Subscribe to SemiAnalysis](https://newsletter.semianalysis.com/subscribe) to read the complete analysis and get access to all of our research._
