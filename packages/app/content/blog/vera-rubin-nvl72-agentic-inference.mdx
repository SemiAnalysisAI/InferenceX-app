...
Originally published on the [SemiAnalysis newsletter](https://newsletter.semianalysis.com/p/vera-rubin-nvl72-agentic-inference) on September 14, 2026, by Bryan Shan, Alec Ibarra, Cam Quilici, Wenyao Gao, and Dylan Patel.

This port reproduces the publicly available portion of the article. The subscriber-only continuation remains on the [original publication](https://newsletter.semianalysis.com/p/vera-rubin-nvl72-agentic-inference).
...
<Figure
  ...
  alt="NVIDIA GTC comparison of Rubin and Blackwell inference performance"
  caption="Source: NVIDIA GTC 2026 SandBagging Rubin Performance"
/>
...
<Figure
  ...
  alt="Organizations supporting, validating, or reproducing InferenceX benchmarks"
...
<Figure
  ...
  alt="InferenceX cross-vendor inference benchmark dashboard"
...
<Figure
  ...
  alt="Agentic workload structure and prefix-cache reuse across turns"
  caption="Source: SemiAnalysis, DeepSeek"
/>

Read more about the methodology in our AgentX article.

[AgentX - InferenceXv3: Does CUDA Moat Hold up in Agentic Inferencing?](https://newsletter.semianalysis.com/p/agentx-inferencexv3-does-cuda-moat)
...
<Figure
  ...
  alt="Rubin and GB300 total tokens per dollar of owning TCO versus P90 interactivity"
  caption="Source: SemiAnalysis InferenceX"
/>
...
<Figure
  ...
  alt="Rubin and GB300 interactivity comparison across serving engines"
  caption="Source: SemiAnalysis InferenceX"
/>
...
<Figure
  ...
  alt="Rubin and GB300 P90 end-to-end latency versus throughput per owning TCO"
  caption="Source: SemiAnalysis InferenceX"
/>
...
<Figure
  ...
  alt="Rubin and GB300 performance per three-year rental TCO"
  caption="Source: SemiAnalysis InferenceX"
/>
...
<Figure
  ...
  alt="Rubin versus single-node Blackwell and MI355X performance per owning TCO"
  caption="Source: SemiAnalysis InferenceX"
/>
...
<Figure
  ...
  alt="Rubin versus single-node Blackwell P90 end-to-end latency"
  caption="Source: SemiAnalysis InferenceX"
/>
...
<Figure
  ...
  alt="Rubin and H200 performance per owning TCO"
  caption="Source: SemiAnalysis InferenceX"
/>

<Figure
  src="/images/vera-rubin-nvl72-agentic-inference/ti-84-calculator.png"
  alt="Texas Instruments TI-84 Plus graphing calculator"
  caption="Source: Texas Instruments"
/>
...
<Figure
  ...
  alt="NVIDIA comparison of Rubin and Blackwell performance per megawatt"
...
<Figure
  ...
  alt="DeepSeek V4 Pro total throughput per utility megawatt versus P90 interactivity"
  caption="Source: SemiAnalysis InferenceX"
/>
...
<Figure
  ...
  alt="Interpolated throughput per utility megawatt at matched interactivity targets"
...
<Figure
  ...
  alt="Annual revenue and modeled profit per utility gigawatt at 75 TPS and 60% utilization"
  caption="Source: SemiAnalysis InferenceX"
/>
...
[Continue reading the subscriber-only fleet lifecycle analysis on SemiAnalysis](https://newsletter.semianalysis.com/p/vera-rubin-nvl72-agentic-inference).
