...
**Upstream stack: the `amd/deepseek_v4` SGLang fork.** [sgl-project/sglang `amd/deepseek_v4`](https://github.com/sgl-project/sglang/compare/main...amd/deepseek_v4) is an actively rebased fork landing AMD-specific DeepSeek-V4-Pro kernels in numbered performance optimization PRs. 31 PRs through 2026-05-22, four primary contributors. The optimizations that moved the curve, grouped by mechanism:
