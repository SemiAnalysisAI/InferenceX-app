...
All rows are DeepSeek-V4-Pro FP4 at **ISL 8192 / OSL 1024** on NVL72, Dynamo vLLM, disaggregated prefill/decode, no speculative decoding, measured on InferenceX on 2026-05-22 ([GHA run 26306422380](https://github.com/SemiAnalysisAI/InferenceX/actions/runs/26306422380)). Cost per million total tokens is `TCO_$/GPU/hr × 1e6 / (3600 × tput_per_gpu)`, with GB200 NVL72 at $2.21/GPU/hr and GB300 NVL72 at $2.65/GPU/hr per the [SemiAnalysis AI Cloud TCO Model](https://newsletter.semianalysis.com/p/ai-cloud-economics).
