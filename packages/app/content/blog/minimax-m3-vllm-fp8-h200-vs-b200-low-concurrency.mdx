...
<Figure
  ...
  alt="MiniMax M3 vLLM FP8 throughput per GPU vs interactivity at ISL/OSL 1024/1024, all four SKUs — B300, B200, H200, H100 — each with non-MTP and MTP variants. At low interactivity (high batch) B300 and B200 lead on per-GPU throughput; the B200 non-MTP curve falls off steeply at high interactivity (low batch) where H200 and even H100 sustain more throughput per GPU."
  caption="MiniMax M3 (428B, MoE) on vLLM FP8 at ISL 1024 / OSL 1024, measured 2026-06-13. B300, B200, H200, and H100, each non-MTP and MTP. Point labels denote tensor-parallel size (4 = TP=4, 8 = TP=8)."
/>
...
<Figure
  srcLight="/images/minimax-m3-vllm-fp8-h200-vs-b200-low-concurrency/benchmark-8k1k-light.png"
  srcDark="/images/minimax-m3-vllm-fp8-h200-vs-b200-low-concurrency/benchmark-8k1k-dark.png"
  alt="MiniMax M3 vLLM FP8 throughput per GPU vs interactivity at ISL/OSL 8192/1024, all four SKUs — B300, B200, H200, H100 — each with non-MTP and MTP variants. B300 and B200 lead at low interactivity (high batch); the B200 non-MTP curve drops off at high interactivity (low batch) where H200 sustains more throughput per GPU."
  caption="MiniMax M3 (428B, MoE) on vLLM FP8 at ISL 8192 / OSL 1024, measured 2026-06-13. Same SKUs and MTP split as the 1024/1024 chart above. Point labels denote tensor-parallel size (4 = TP=4, 8 = TP=8)."
/>
