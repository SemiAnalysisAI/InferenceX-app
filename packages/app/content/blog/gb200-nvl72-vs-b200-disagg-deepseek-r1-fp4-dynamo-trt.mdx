...
On DeepSeek R1 0528 FP4 1k/1k with Dynamo TRT-LLM + MTP and disaggregated prefill/decode on both SKUs, [GB200 NVL72](https://inferencex.semianalysis.com/gpu-specs) delivers **up to 4.39x throughput per GPU vs B200 at iso-interactivity** — peaking at 125 tok/s/user (4,130 tok/s/GPU on GB200 NVL72 vs 941 tok/s/GPU on [B200](https://inferencex.semianalysis.com/gpu-specs)).
